    ...
    <div className="bg-linear-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-4 mb-6 bg-[rgba(0,0,0,0)]">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto px-6 py-2 bg-[rgb(0,0,0)] text-white rounded-lg hover:bg-blue-700 transition-colors whitespace-nowrap text-sm font-medium flex items-center justify-center gap-2"
        >
