...
export function EventSelection({ onSelectEvent, onBack, selectedEventId, userProfile }: EventSelectionProps) {
  ...
  return (
    <div className="flex-1 overflow-auto pt-8 lg:pt-37.5 px-4 lg:pr-8 lg:pb-8 lg:pl-8">
